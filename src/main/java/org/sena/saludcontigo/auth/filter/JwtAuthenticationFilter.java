package org.sena.saludcontigo.auth.filter;
...
import static org.sena.saludcontigo.auth.TokenJwtConfig.*;
...
public class JwtAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, FilterChain chain,
        ...
        boolean isPatient = roles.stream().anyMatch(role -> role.getAuthority().equals("ROLE_PATIENT"));
        Claims claims = Jwts
                .claims()
